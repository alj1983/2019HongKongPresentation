...
\draw[color=red,line width=0.05cm] (2.1cm,1.6cm) rectangle (2.6,2.2);
\draw[color=red,line width=0.05cm] (2.1cm,-0.7cm) rectangle (2.6,0.15cm);

\draw[color=red,line width=0.05cm] (6.55cm,-0.7cm) rectangle (7.05cm,1.25cm);
\draw[color=red,line width=0.05cm] (6.55cm,-2.2cm) rectangle (7.05cm,-1.5cm);
