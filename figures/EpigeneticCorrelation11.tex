...
\draw [latex-latex,line width=0.02cm] (0.5cm,-0.2cm) -- node [scale=0.7,below=0.2cm,color=red!80!black]{correlated} (3.5cm,-0.5);

\draw [latex-latex,line width=0.02cm] (0.5cm,-0.2cm) -- node [scale=0.7,below=0.2cm]{correlated} (3.5cm,-4.5);
